...
namespace CarRepair.API.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            SignInManager<CarRepairUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new CarRepairUser { UserName = Input.Email, Email = Input.Email, Lastname = Input.Lastname, Firstname = Input.Firstname };
